...
Além das alterações no algoritmo do otimizador, foi necessário rever também a modelagem do banco de dados, visando armazenar os valores das métricas de qualidade de uma forma mais geral.
